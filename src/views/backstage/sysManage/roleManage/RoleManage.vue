<template>
  <div id="roleMaeage">
    <el-row>
      <el-col :span="6">
        <el-input class="mar-r-10 mar-b-20" v-model="nameTxt" placeholder="角色名称"></el-input>
      </el-col>
      <el-col :span="12">
        <el-button class="mar-l-10 mar-b-20" @click="queryUser">查询</el-button>
        <el-button class="mar-l-10 mar-b-20" type="primary" @click="addRole">新增</el-button>
        <el-button class="mar-l-10 mar-b-20" type="primary" @click="editRole">修改</el-button>
        <el-button class="mar-l-10 mar-b-20" type="warning" @click="showPowerDialog">分配权限</el-button>
      </el-col>
    </el-row>

    <!-- 表格 -->
    <el-row class="pad-t-10 ">
      <el-table border :data="tableDatas" style="width:100%" @selection-change="handleSelectionChange">
        <el-table-column type="index" label=" "></el-table-column>
        <el-table-column type="selection"></el-table-column>
        <el-table-column prop="roleName" label="角色名称"></el-table-column>
        <el-table-column prop="appCode" label="所属系统"></el-table-column>
        <el-table-column prop="remark" label="备注"></el-table-column>
        <el-table-column prop="opearUser" label="操作人"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button size="mini" :loading="btnloading" @click="roleDetail(scope.$index, scope.row)">详情</el-button>
          </template>
        </el-table-column>
    ...
    <!-- 弹框 -->
    <el-dialog title="权限分配" :visible.sync="allotPower" @close="closeDialog" center>
      <el-tree ref="tree" @check-change="checkCahnge" :data="dataTree" :show-checkbox="true" node-key="id" :default-checked-keys="treeIds" :default-expand-all="true" :props="defaultProps" :check-strictly="true"></el-tree>
